...
int main(int argc, char** argv)
{
	...
	CALLISTO_PROFILE_BEGIN_SESSION("Startup", "./Diagnostics/CallistoProfile_Startup.json");
	auto app = Callisto::CreateApplication();
	CALLISTO_PROFILE_END_SESSION();

	CALLISTO_PROFILE_BEGIN_SESSION("Running", "./Diagnostics/CallistoProfile_Running.json");
	app->Run();
	CALLISTO_PROFILE_END_SESSION();

	CALLISTO_PROFILE_BEGIN_SESSION("Shutdown", "./Diagnostics/CallistoProfile_Shutdown.json");
	delete app;
	CALLISTO_PROFILE_END_SESSION();
